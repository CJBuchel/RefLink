...
const PanelType$json = {
  '1': 'PanelType',
  '2': [
    {'1': 'PANEL_TYPE_UNSPECIFIED', '2': 0},
    {'1': 'PANEL_TYPE_HEAD_REFEREE', '2': 1},
    {'1': 'PANEL_TYPE_RED_NEAR', '2': 2},
    {'1': 'PANEL_TYPE_RED_FAR', '2': 3},
    {'1': 'PANEL_TYPE_BLUE_NEAR', '2': 4},
    {'1': 'PANEL_TYPE_BLUE_FAR', '2': 5},
  ],
};

/// Descriptor for `PanelType`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List panelTypeDescriptor = $convert.base64Decode(
    'CglQYW5lbFR5cGUSGgoWUEFORUxfVFlQRV9VTlNQRUNJRklFRBAAEhsKF1BBTkVMX1RZUEVfSE'
    'VBRF9SRUZFUkVFEAESFwoTUEFORUxfVFlQRV9SRURfTkVBUhACEhYKElBBTkVMX1RZUEVfUkVE'
    'X0ZBUhADEhgKFFBBTkVMX1RZUEVfQkxVRV9ORUFSEAQSFwoTUEFORUxfVFlQRV9CTFVFX0ZBUh'
    'AF');
...
@$core.Deprecated('Use autoClimbStateDescriptor instead')
const AutoClimbState$json = {
  '1': 'AutoClimbState',
  '2': [
    {'1': 'AUTO_CLIMB_STATE_UNSPECIFIED', '2': 0},
    {'1': 'AUTO_CLIMB_STATE_NOTHING', '2': 1},
    {'1': 'AUTO_CLIMB_STATE_LEVEL_1', '2': 2},
  ],
};

/// Descriptor for `AutoClimbState`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List autoClimbStateDescriptor = $convert.base64Decode(
    'Cg5BdXRvQ2xpbWJTdGF0ZRIgChxBVVRPX0NMSU1CX1NUQVRFX1VOU1BFQ0lGSUVEEAASHAoYQV'
    'VUT19DTElNQl9TVEFURV9OT1RISU5HEAESHAoYQVVUT19DTElNQl9TVEFURV9MRVZFTF8xEAI=');
...
final $typed_data.Uint8List cardTypeDescriptor = $convert.base64Decode(
    'CghDYXJkVHlwZRIZChVDQVJEX1RZUEVfVU5TUEVDSUZJRUQQABIUChBDQVJEX1RZUEVfWUVMTE'
    '9XEAESEQoNQ0FSRF9UWVBFX1JFRBAC');

@$core.Deprecated('Use endgameClimbStateDescriptor instead')
const EndgameClimbState$json = {
  '1': 'EndgameClimbState',
  '2': [
    {'1': 'ENDGAME_CLIMB_STATE_UNSPECIFIED', '2': 0},
    {'1': 'ENDGAME_CLIMB_STATE_NOTHING', '2': 1},
    {'1': 'ENDGAME_CLIMB_STATE_LEVEL_1', '2': 2},
    {'1': 'ENDGAME_CLIMB_STATE_LEVEL_2', '2': 3},
    {'1': 'ENDGAME_CLIMB_STATE_LEVEL_3', '2': 4},
  ],
};

/// Descriptor for `EndgameClimbState`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List endgameClimbStateDescriptor = $convert.base64Decode(
    'ChFFbmRnYW1lQ2xpbWJTdGF0ZRIjCh9FTkRHQU1FX0NMSU1CX1NUQVRFX1VOU1BFQ0lGSUVEEA'
    'ASHwobRU5ER0FNRV9DTElNQl9TVEFURV9OT1RISU5HEAESHwobRU5ER0FNRV9DTElNQl9TVEFU'
